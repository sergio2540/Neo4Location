...
//    }
    ...
    protected void reActivateDatabase(boolean deleteDb, boolean useBatchInserter, boolean autoTx) throws Exception {
        ...
        if (useBatchInserter) {
            ...
            //db = new SpatialBatchGraphDatabaseService(batchInserter);
        } else {
    ...
    //remover o de cima protected
    //Falta acabar ver: http://neo4j.com/docs/milestone/javadocs/org/neo4j/jmx/package-summary.html
    protected void _printDatabaseStats(){
